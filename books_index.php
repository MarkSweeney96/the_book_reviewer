...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h2>Books <a href="books_create.php" class="btn btn-primary pull-right">Add Book</a></h2>
                            ...
                            <tbody>
                                <?php foreach ($books as $book) { ?>
                                    <tr data-id="<?= $book->id ?>">
                                        ...
                                        <td><?= Author::find($book->author_id)->first_name ?> <?= Author::find($book->author_id)->last_name ?></td>
                                        <td><?= $book->isbn ?></td>
